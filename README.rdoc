...
= Roadmap
  ...
  * Whats a Cucumber GUI without its own feature sets. These were referred to as "demos" by the original developer but none were ever written
  * Fix fatal bugs that currently stop normal usage (See http://westwardwd.lighthouseapp.com/projects/46048-rcumber/tickets)  
